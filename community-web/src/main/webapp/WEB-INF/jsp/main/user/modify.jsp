...
<html>
  <head>
    ...
    <script type="text/javascript" src="${path}/js/main/modifyUser.js"></script>
  </head>
...
<body>
	<div class="content">
		...
		<!--cont start-->
		<form id="form1" name="form1" method="get" action="${path}/manage/user/modify">
			<div class="cont1">
				<div class="xg_zhsz">
						...
						<div class="zxxg_zhsz1">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td colspan="4">
										<label>
											<input type="text" placeholder="真实姓名" name="realName" value="${user.realName}" id="realName" maxlength="5" class="zhsz_1_k" /> 
								...
								<tr>
									...
									<td>
										<input type="radio" name="gender" id="sex_male" value="1" ${(user.gender eq 1)?'checked=checked':''} class="khgl_xz" style="float:left;" /> 
										<label for="sex_male" style="float:left;">
											男&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										</label> 
										<input type="radio" name="gender" id="sex_female" value="0" ${(user.gender eq 0)?'checked=checked':''} class="khgl_xz" style="float:left;" /> 
								...
								<tr>
									...
									<td>
										<label>
											<input type="text" maxlength="11" value="${user.mobile}" name="mobile" placeholder="手机号码" id="mobile" class="zhsz_1_k" />
											<label style="color: red;">*</label>	
										</label>
									</td>
									<td height="43" align="right" valign="middle">电子邮箱：</td>
									<td colspan="4">
										<input type="text" maxlength="30" name="email" value="${user.email}" id="email" class="zhsz_1_k" />
									</td>
								</tr>
