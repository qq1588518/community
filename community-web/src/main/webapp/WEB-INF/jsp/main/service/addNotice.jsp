...
<body>
	<div class="content">
		...
		<!--cont start-->
		<form id="form1" name="form1" method="post" action="${path}/service/notice/saveNotice" enctype="multipart/form-data" accept-charset="utf-8">
			<div class="cont1">
				<div class="xg_zhsz">
						...
						<div class="zxxg_zhsz1">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="295 ">
										<label> 
											<input id="title" placeholder="标题" type="text" maxlength="20" name="title" class="zhsz_1_k" />
								...
								<tr>
								  <td height="43" align="right" valign="middle">图片：</td>
									...
									<div id="divNewPreview">
										<img id="noticeImg" alt="无" width="150px" height="150px">
									</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan="4">
										<label>
										<textarea class="zhsz_1_wb" rows="10" name="content" maxlength="1000" cols="50" placeholder="内容..."></textarea>
											<label style="color: red;">*</label>
										</label>
									</td>
								</tr>
