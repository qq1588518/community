			...
			<div class="xg_zhsz">
				<c:choose>
					<c:when test="${!empty brief}">
						...
						<div class="zxxg_zhsz fl">
							<p class="xg_zhsz_bt" style="margin-top: 0px;">&nbsp;&nbsp;项目内容&nbsp;&nbsp;</p>
							<div class="zxxg_zhsz1">
								<div class="w_apply">
							    ...
							    <c:if test="${brief.flowType == 8}">
						    		<div class="zxxg_zhsz fl">
										<p class="xg_zhsz_bt" style="margin-top: 0px;">&nbsp;&nbsp;附件&nbsp;&nbsp;</p>
										<div class="w_apply" style="width:920px; padding-left:70px;">
											<c:forEach items="${filesList }" var="img">
												<div class="w_main_info_text" style="width:200px; padding:5px; height:200px;">
										            <img width=100% height=100% src="${img.path}">
										         </div>
											</c:forEach>
									    </div>
									</div>
						...
						<div class="zxxg_zhsz fl" style="background:#FFF;">
							<c:if test="${(brief.status eq 1)||(brief.status eq 2)}">
							...
							<div class="zxxg_zhsz1">
								<div style="width:1000px;float:left;">
									...
									<c:if test="${brief.status eq 2}">
									    <table width="100%" border="0" cellspacing="0" cellpadding="0">
									      <tr>
									        <td width="340" height="50" align="right" valign="middle">
									        	<input type="radio" class="khgl_xz" value="4" checked="checked" name="status">
									        </td>
									        <td width="340" align="left" valign="middle">结束</td>
									      </tr>
									   </table>
									    <div class="w_main_info_name" align="center" style="vertical-align: middle;line-height: 40px;">备注：</div>
								        <div class="w_flow_remark">
							        ...
							        <table width="100%" border="0" cellspacing="0" cellpadding="0">
							        	<tr align="center" valign="middle" style="height:60px;line-height: 60px;">
											<c:choose>
												<c:when test="${(brief.status eq 1)||(brief.status eq 2)}">
													...
													<td align="center" valign="middle">
														<label>
															<a href="${referer}" class="bajy_bb_xkgl_btn_black" style="display: block;color: white;">
																返&nbsp;&nbsp;回
															</a>
														</label>
													</td>
