...
<script type="text/javascript" src="${path}/js/mobile/notice/addActivities.js"></script></head>

<body>
	<div class="gridContainer">
	<form id="form1"   action="${path}/mobile/activities/save"  enctype="multipart/form-data"   method="post">
		<div id="LayoutDiv1">
			<div class="main" style="background:#fff;">
				<div class="notice_conte">
					<div class="notice_release_lin">
						...
						<input class="notice_release_input_sty"id="title" placeholder="活动主题" type="text" maxlength="20" name="title"  />
						</div>
					</div>
					<div class="notice_release_lin">
						<div class="notice_release_nam">日期：</div>
						<div class="notice_release_input">
						<input type="text" class="notice_release_input_sty" name="time" placeholder="活动时间"  readonly="readonly"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'%y-%M-%d'})"/>
						</div>
					</div>
					<div class="notice_release_lin">
						<div class="notice_release_nam">人数：</div>
						<div class="notice_release_input">
							<input  id="peopleLow" name="peopleLow" placeholder="最少" class="notice_release_input_sty01" type="text"  />--
							<input  id="peopleHigh" name="peopleHigh" placeholder="最多" class="notice_release_input_sty01" type="text"  />人
						</div>
					</div>
					</div>
				</div>
				<div class="notice_conte">
					...
					<div class="play_Scolumn_pic">
	                	<div id="divNewPreview" class="play_Scolumn_pic_bor">
	                	   <img  onclick="fileclick();" id="activitiesImg"  width="100%" height="100%"</div>
						<input style="height: 0px;width: 0px;display: none;"  type="file" name="file" id="file" onchange="PreviewImage(this,'activitiesImg','divNewPreview')"/>
	                	</div>
	                </div>
				...
				<div class="notice_button">
							<div class="notice_button1">
								<input type="submit" class="notice_button_sty" value="发起活动" />
							</div>
